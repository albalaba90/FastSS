...
powershell -NoProfile -Command "gps java,javaw -ea 0 | ft ProcessName,Id,@{N='Started';E={$_.StartTime.ToString('yyyy-MM-dd HH:mm:ss')}},@{N='Runtime';E={('{0:dd\.hh\:mm\:ss}' -f ((Get-Date)-$_.StartTime))}} -AutoSize"
